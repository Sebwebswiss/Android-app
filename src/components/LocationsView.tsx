...
import { Box, MapPin, ChevronRight, Plus, QrCode, ArrowLeft, Edit2 } from 'lucide-react';
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 bg-white p-4 sm:p-5 rounded-2xl border border-slate-200">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              title={t.locations.editRoomBtn}
            >
              <Edit2 className="w-3.5 h-3.5 text-slate-600" />
              <span className="hidden sm:inline">{t.locations.editRoomBtn}</span>
            </button>
            {selectedContainer && (
              <button
